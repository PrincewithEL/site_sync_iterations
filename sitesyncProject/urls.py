...
urlpatterns = [
    ...
    path('projects/<int:project_id>/pin_message/', views.pin_message, name='pin_message'),
    path('projects/<int:project_id>/unpin_message/', views.unpin_message, name='unpin_message'),
    path('projects/<int:project_id>/bookmark_message/', views.bookmark_message, name='bookmark_message'),
    path('projects/<int:project_id>/unbookmark_message/', views.unbookmark_message, name='unbookmark_message'),
    ...
    path('api/edit-message/<int:pk>/', EditMessageAPIView, name='edit_message_api'),
    path('api/delete-message/<int:pk>/', DeleteMessageAPIView, name='delete_message_api'),
    ...
    path('api/projects/<int:pk>/resources/add/', AddResourceView, name='api_add_resource'),
    path('api/projects/<int:pk>/resources/delete/<int:resource_id>/', DeleteResourceView, name='api_delete_resource'),
    path('api/projects/<int:pk>/tasks/', TaskListView.as_view(), name='tasks-list'),
    path('api/projects/<int:pk>/tasks/add/', AddTaskAPIView, name='add_task_api'),
    path('api/projects/<int:pk>/tasks/<int:task_id>/delete/', DeleteTaskAPIView, name='delete_task_api'),
    path('api/projects/<int:pk>/tasks/<int:task_id>/complete/', CompleteTaskAPIView, name='complete_task_api'),
    path('api/projects/<int:pk>/resources/<int:resource_id>/restore/', RestoreResourceAPI, name='restore_resource'),
    path('api/projects/<int:pk>/resources/<int:resource_id>/hide/', HideResourceAPI, name='hide_resource'),
    path('api/projects/<int:pk>/delete/', DeleteProjectAPI, name='delete_project'),
    path('api/projects/<int:pk>/restore/', RestoreProjectAPI, name='restore_project'),
    path('api/projects/<int:pk>/hide/', HideProjectAPI, name='hide_project'),
    path('api/projects/<int:pk>/tasks/<int:task_id>/restore/', RestoreTaskAPI, name='restore_task'),
    path('api/projects/<int:pk>/tasks/<int:task_id>/hide/', HideTaskAPI, name='hide_task'),
