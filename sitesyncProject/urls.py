...
urlpatterns = [
    ...
    path('api/forgot-password/', ForgotPasswordAPI, name='forgot_password_api'),
    path('api/verify-otp/', VerifyOtpAPI, name='verify_otp_api'),
    path('api/verify-otp1/', VerifyOtp1API, name='verify_otp1_api'),
    path('api/reset-password/', ResetPasswordAPI, name='reset_password_api'),
